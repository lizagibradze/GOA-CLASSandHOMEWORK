...
# 1) შექმანთ tuple სია რომელშიც იქნება 6 საყვარელი ფილმი ჩაგდებული
# გამოვიტანოთ Unpack Tuples მეთოის გამოყენებტ 1 ფილმი ცალკე, ხოლო დანარჩენი 5 კი გამოვიტანოთ list სახით 
# 2) პიველი და ბოლო ელემენტი დავპრინტოთ <3 
